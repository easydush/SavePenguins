...
public class Message02Move extends Message{
    ...
    public Message02Move(byte[] data) {
        super(02);
    ...
    public Message02Move(String username, int x, int y, int numSteps, boolean isMoving, int movingDir) {
        super(02);
